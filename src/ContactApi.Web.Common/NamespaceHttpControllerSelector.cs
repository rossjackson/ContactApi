...
namespace ContactApi.Web.Common
{
    public class NamespaceHttpControllerSelector : IHttpControllerSelector
    {
        ...
        public HttpControllerDescriptor SelectController(HttpRequestMessage request)
        {
            ...
            if (_controllers.Value.TryGetValue(controllerKey, out var controllerDescriptor))
            {
        ...
        private string GetControllerName(IHttpRouteData routeData)
        {
            ...
            var controllerName = ((HttpActionDescriptor[]) dataTokenValue).First().ControllerDescriptor.ControllerName
